...
<main class="shell">
  ...
  <div class="card">
    ...
    <div class="soon">The rest are being recorded and will appear here as they're ready: the two-minute straw breath, and one for the inner critic, for when the voice sounds like the truth.</div>
  </div>
