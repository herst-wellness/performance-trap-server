...
const WEEKS = {
  ...
  2: {
    ...
    opening: 'Bring me something today that you\'d normally go into fix-it mode around or push past. We\'re going to sit with it instead.',
    methods: [SENSE_FULL],
  },
  3: {
    title: 'Week 3: Turning Contact Into Choice',
    sub: 'The pause, the trade, the third option, one honest sentence.',
    opening: 'Bring me a moment in the recent past between you and someone else, a moment where you felt something was off. It could have been a strong disagreement or something more subtle than that.',
    methods: [SENSE_FULL, STEP_METHOD],
  },
  4: {
    title: 'Week 4: Integration and the Doorway',
    sub: 'The whole arc, run on real life.',
    opening: 'Where are you feeling stuck today?',
    methods: [SENSE_FULL, STEP_METHOD],
  },
};
...
const JOURNAL = {
  ...
  2: {
    journal: true,
    week: 2,
    title: 'Week 2: the journal sitting',
    sub: 'Bring what you wrote. It reads it back, and the body answers.',
    journals: [
      { key: 'week-2/the-protector', title: 'The Protector' },
      { key: 'week-2/the-return', title: 'The Return' },
    ],
    methods: [JOURNAL_METHOD],
    weekFrame: readPart('onramp-journal-week-2.txt'),
    pagePath: '/practice/on-ramp/journal-2',
    apiPath: '/api/on-ramp/journal-2',
  },
  3: {
    journal: true,
    week: 3,
    title: 'Week 3: the journal sitting',
    sub: 'Bring what you wrote. It reads it back, and the body answers.',
    journals: [
      { key: 'week-3/the-trade', title: 'The Trade' },
      { key: 'week-3/the-third-option', title: 'The Third Option' },
    ],
    methods: [JOURNAL_METHOD],
    weekFrame: readPart('onramp-journal-week-3.txt'),
...
` : `    <h2>Welcome to the daily rep</h2>
    <p>If you are here, you have the map: SENSE for coming back to the intelligence of the body, STEP for changing the conversations that keep you stuck. This is where you get the reps. You bring one real moment from your day, and we run the practice on it together.</p>
