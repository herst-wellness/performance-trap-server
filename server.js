...
const { handleOnrampListenRoute } = require('./onramp-listen');
...
<body>
  ...
  if (req.method === 'GET' && req.url === '/listen/chapter-six') {
    const ch6html = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="robots" content="noindex, nofollow">
<title>Chapter Six — The Performance Trap</title>
<link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700&family=Cormorant+Garamond:ital,wght@0,400;0,500;1,400&display=swap" rel="stylesheet">
<style>
  body { margin:0; padding:0; background:#F4EDE4; font-family:'Cormorant Garamond',Georgia,serif; color:#352515; }
  .wrap { max-width:600px; margin:0 auto; padding:40px 20px; }
...
<body>
  <div class="wrap">
    ...
    <hr class="divider" />
    <h1>Chapter Six</h1>
    <p class="subtitle">The Good Kid</p>
    <p>This is the chapter where the role finally gets named. The knot in the gut that had been sitting there for decades. The confession I couldn't make until my body forced it out of me.</p>
    <div class="player-wrap">
      <audio controls preload="metadata" src="${AUDIO_BASE_URL}/09-ch06-the-good-kid.mp3">
        Your browser does not support audio playback.
      </audio>
      <div class="duration">16 minutes</div>
    </div>
    <div class="footer">
      <img src="${LOGO_URL}" alt="Herst Wellness" />
      <p>765 Market St, San Francisco, CA 94103<br>(415) 686-4411 &middot; <a href="mailto:chad@herstwellness.com">chad@herstwellness.com</a></p>
   ...
   if (req.method === 'GET' && req.url === '/listen/introduction') {
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="robots" content="noindex, nofollow">
<title>Introduction — The Performance Trap</title>
<link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700&family=Cormorant+Garamond:ital,wght@0,400;0,500;1,400&display=swap" rel="stylesheet">
<style>
  body { margin:0; padding:0; background:#F4EDE4; font-family:'Cormorant Garamond',Georgia,serif; color:#352515; }
  .wrap { max-width:600px; margin:0 auto; padding:40px 20px; }
...
<body>
  <div class="wrap">
    ...
    <hr class="divider" />
    <h1>Introduction</h1>
    <p class="subtitle">The Performance Trap</p>
    <p>This is where the framework gets named. What the performance trap is, where it comes from, and why the people who look like they have it together are often the ones carrying the most.</p>
    <div class="player-wrap">
      <audio controls preload="metadata" src="${AUDIO_BASE_URL}/02-introduction.mp3">
        Your browser does not support audio playback.
      </audio>
  ...
  if (req.method === 'GET' && req.url === '/press/chapter-one') {
...
<body>
  <div class="wrap">
    ...
    <h1>Chapter One</h1>
    <p class="subtitle">The Day the Mask Cracked</p>
    <p>The opening chapter of The Performance Trap, read by the author. The phone call, my brother, and the day everything I'd built started to come apart. Twenty-eight minutes.</p>
    <div class="player-wrap">
      <audio controls preload="metadata" src="${CHAPTER_ONE_AUDIO_URL}">
        Your browser does not support audio playback.
      </audio>
    ...
    <p>The book releases October 1, 2026. For a review copy in any format, write to <a href="mailto:chad@herstwellness.com">chad@herstwellness.com</a>.</p>
    <div class="footer">
      <img src="${LOGO_URL}" alt="Herst Wellness" />
      <p>765 Market St, San Francisco, CA 94103<br>(415) 686-4411 &middot; <a href="mailto:chad@herstwellness.com">chad@herstwellness.com</a></p>
      <p><a href="https://herstwellness.com">herstwellness.com</a></p>
...
<body>
  ...
  if (req.method === 'GET' && req.url === '/listen/newsletter-04') {
    const nl04html = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="robots" content="noindex, nofollow">
<title>Newsletter Four — Chad Herst</title>
<link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700&family=Cormorant+Garamond:ital,wght@0,400;0,500;1,400&display=swap" rel="stylesheet">
<style>
  body { margin:0; padding:0; background:#F4EDE4; font-family:'Cormorant Garamond',Georgia,serif; color:#352515; }
  .wrap { max-width:600px; margin:0 auto; padding:40px 20px; }
...
<body>
  ...
  if (req.method === 'GET' && req.url === '/listen/newsletter-05') {
    const nl05html = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="robots" content="noindex, nofollow">
<title>Newsletter Five — Chad Herst</title>
<link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700&family=Cormorant+Garamond:ital,wght@0,400;0,500;1,400&display=swap" rel="stylesheet">
<style>
  body { margin:0; padding:0; background:#F4EDE4; font-family:'Cormorant Garamond',Georgia,serif; color:#352515; }
  .wrap { max-width:600px; margin:0 auto; padding:40px 20px; }
...
<body>
  <div class="wrap">
    ...
    <p class="subtitle">It's still hard for me to ask</p>
    <p>Earlier this week some heavy news landed, and I reached for the move I've made almost my whole life: turn inward and handle it alone. This time I did something different.</p>
    <div class="player-wrap">
      <audio controls preload="metadata" src="${AUDIO_BASE_URL}/newsletter-05.mp3">
        Your browser does not support audio playback.
      </audio>
  ...
  if (req.method === 'GET' && req.url === '/listen/newsletter-06') {
    const nl06html = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="robots" content="noindex, nofollow">
<title>Newsletter Six — Chad Herst</title>
<link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700&family=Cormorant+Garamond:ital,wght@0,400;0,500;1,400&display=swap" rel="stylesheet">
<style>
  body { margin:0; padding:0; background:#F4EDE4; font-family:'Cormorant Garamond',Georgia,serif; color:#352515; }
  .wrap { max-width:600px; margin:0 auto; padding:40px 20px; }
...
<body>
  <div class="wrap">
    <img src="${LOGO_URL}" alt="Herst Wellness" class="logo-top" />
    <hr class="divider" />
    <h1>Newsletter Six</h1>
    <p class="subtitle">I told him I was nervous</p>
    <p>Fifteen minutes into a podcast about the book, I told the host I was anxious. The old move would have been to breathe it down. This time I let the flutter stay.</p>
    <div class="player-wrap">
      <audio controls preload="metadata" src="${AUDIO_BASE_URL}/newsletter-06.mp3">
        Your browser does not support audio playback.
      </audio>
      <div class="duration">3 minutes</div>
    </div>
  ...
  if (req.method === 'GET' && req.url === '/listen/newsletter-08') {
    const nl08html = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="robots" content="noindex, nofollow">
<title>Newsletter Eight — Chad Herst</title>
<link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700&family=Cormorant+Garamond:ital,wght@0,400;0,500;1,400&display=swap" rel="stylesheet">
<style>
  body { margin:0; padding:0; background:#F4EDE4; font-family:'Cormorant Garamond',Georgia,serif; color:#352515; }
  .wrap { max-width:600px; margin:0 auto; padding:40px 20px; }
...
<body>
  <div class="wrap">
    <img src="${LOGO_URL}" alt="Herst Wellness" class="logo-top" />
    <hr class="divider" />
    <h1>Newsletter Eight</h1>
    <p class="subtitle">The assignment was to tell the truth</p>
    <p>I once wrote something very good, but I hated it. It took me a while to see the answer: none of it was me telling the truth about my story.</p>
    <div class="player-wrap">
      <audio controls preload="metadata" src="${AUDIO_BASE_URL}/newsletter-08.mp3">
        Your browser does not support audio playback.
      </audio>
      <div class="duration">4&frac12; minutes</div>
    </div>
    <p>The writing class in this letter is real, and Lori Saltzman still teaches it. One prompt, a few minutes of silence, and one rule: tell the truth.</p>
    <div class="class-wrap">
      <a class="class-btn" href="https://www.openfloordance.org/my-word">Lori's class: My Word</a>
    </div>
    <div class="footer">
      <img src="${LOGO_URL}" alt="Herst Wellness" />
      <p>765 Market St, San Francisco, CA 94103<br>(415) 686-4411 &middot; <a href="mailto:chad@herstwellness.com">chad@herstwellness.com</a></p>
  ...
  if (req.method === 'GET' && req.url === '/listen/newsletter-09') {
    const nl09html = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
  <div class="wrap">
    ...
    <p class="subtitle">My father thinks the book is selfish</p>
    <p>Earlier this summer, my father and I took a fishing trip. I knew he had some qualms with my book, so I brought it up at our first dinner.</p>
    <div class="player-wrap">
      <audio controls preload="metadata" src="${AUDIO_BASE_URL}/newsletter-09.mp3">
        Your browser does not support audio playback.
      </audio>
      <div class="duration">5&frac12; minutes</div>
    </div>
    <p>The book comes out October 1. If I haven't already given you a copy, I'd love to do so, as audio in my own voice, or EPUB, or PDF. All I ask is an honest review on Amazon around launch time.</p>
    <div class="class-wrap">
      <a class="class-btn" href="https://herstwellness.com/launch-team">Join the launch team</a>
    </div>
    <div class="footer">
      <img src="${LOGO_URL}" alt="Herst Wellness" />
      <p>765 Market St, San Francisco, CA 94103<br>(415) 686-4411 &middot; <a href="mailto:chad@herstwellness.com">chad@herstwellness.com</a></p>
  ...
  if (req.method === 'GET' && req.url === '/listen/newsletter-10') {
    const nl10html = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="robots" content="noindex, nofollow">
<title>Newsletter Ten — Chad Herst</title>
<link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700&family=Cormorant+Garamond:ital,wght@0,400;0,500;1,400&display=swap" rel="stylesheet">
<style>
  body { margin:0; padding:0; background:#F4EDE4; font-family:'Cormorant Garamond',Georgia,serif; color:#352515; }
  .wrap { max-width:600px; margin:0 auto; padding:40px 20px; }
...
<body>
  <div class="wrap">
    <img src="${LOGO_URL}" alt="Herst Wellness" class="logo-top" />
    <hr class="divider" />
    <h1>Newsletter Ten</h1>
    <p class="subtitle">I said yes with my mouth</p>
    <p>In May I wrote about the night I woke up at 3 a.m. with my gut in knots. I never told you what happened the next morning.</p>
    <div class="player-wrap">
      <audio controls preload="metadata" src="${AUDIO_BASE_URL}/newsletter-10.mp3">
        Your browser does not support audio playback.
      </audio>
      <div class="duration">5&frac12; minutes</div>
    </div>
    <p>The book comes out October 1, three weeks from now. This is the last time I'll ask before it's out. If I haven't already given you a copy, I'd love to: audio in my own voice, or EPUB, or PDF. What I'd ask in return is an honest review on Amazon around launch.</p>
    <div class="class-wrap">
      <a class="class-btn" href="https://herstwellness.com/launch-team">Join the launch team</a>
    </div>
    <div class="footer">
  ...
  if (req.method === 'GET' && req.url === '/listen/launch-team-reminder') {
    const ltrHtml = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="robots" content="noindex, nofollow">
<title>To the launch team — Chad Herst</title>
<link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700&family=Cormorant+Garamond:ital,wght@0,400;0,500;1,400&display=swap" rel="stylesheet">
<style>
  body { margin:0; padding:0; background:#F4EDE4; font-family:'Cormorant Garamond',Georgia,serif; color:#352515; }
  .wrap { max-width:600px; margin:0 auto; padding:40px 20px; }
...
<body>
  <div class="wrap">
    <img src="${LOGO_URL}" alt="Herst Wellness" class="logo-top" />
    <hr class="divider" />
    <h1>To the launch team</h1>
    <p class="subtitle">Why this book matters so much to me, and why your review helps</p>
    <p>The reason you're hearing from me is because you're on my launch team. However you got here, thank you.</p>
    <div class="player-wrap">
      <audio controls preload="metadata" src="${AUDIO_BASE_URL}/launch-team-reminder.mp3">
        Your browser does not support audio playback.
      </audio>
      <div class="duration">4 minutes</div>
    </div>
    <p>The book comes out Thursday, October 1. On the morning of October 2, you'll get one email from me with the Amazon link. That's the day I'll ask for your honest review. If you never got the book, or you can't find the email, everything is at the link below: the audio in my voice, the EPUB, the PDF.</p>
    <div class="class-wrap">
      <a class="class-btn" href="https://herstwellness.com/book">Get the book</a>
    </div>
    <div class="footer">
      <img src="${LOGO_URL}" alt="Herst Wellness" />
      <p>765 Market St, San Francisco, CA 94103<br>(415) 686-4411 &middot; <a href="mailto:chad@herstwellness.com">chad@herstwellness.com</a></p>
  ...
  <div class="wrap">
    ...
    <div class="player-wrap">
      <div class="player-header">
        <img src="${BASE_URL}/book-cover-current.jpg?v=knot-2026-09-07" alt="The Performance Trap cover" class="player-header-cover" />
...
<span><strong id="progress-remaining">${totalDurationText}</strong></span>        </div>
    ...
    <div class="downloads">
      <a class="dl-card" href="${BASE_URL}/downloads/the-performance-trap-v2.3.epub" download>
        <img src="${BASE_URL}/book-cover-current.jpg?v=knot-2026-09-07" alt="The Performance Trap cover" />
