...
<p>Before you can meet yourself with any curiosity, before you can hear what your body has been trying to tell you, the nervous system has to settle. You can't do this work in fight or flight. You can't approach what's tender from inside the panic that's trying to outrun it. The breath is the doorway. It's the lever your nervous system gives you to shift, in real time, from the speed of survival into a state where presence becomes possible. We always have access to it. Few of us ever learn how to use it.</p>
...
<p>This shift isn't instant. Over five to ten minutes of slow, smooth breathing, the biology changes. The mind, which had been running on the assumption of threat, starts to find that the threat isn't there. That's the moment the work becomes possible. If you like the technical name, this kind of slow, paced breathing is what researchers call resonance breathing. It lowers the heart rate and raises what's known as heart rate variability, and you can track it with a heart rate monitor if you want to. You don't need the term.</p>
<h4>Fitting the breath to the state you're in</h4>
<p>Here's the part no app can do for you. Five in and seven out calms the system. That's right when you're jumpy and agitated. But some days you're not jumpy. You're dull and heavy, maybe a little exhausted. On those days you follow the in breath all the way to the end instead. Breathe into the lower belly, the upper belly, the ribs, the center of the chest, and keep the exhale smooth. Longer inhales and shorter exhales pick things up a little. Sometimes even some shorter, quicker breathing helps, for about twenty breaths, and then you let it go and come back into the body. And if you're already even, keep it even.</p>
