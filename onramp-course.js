...
<p>Someone I worked with came to me having already done a great deal of work on themselves. They had read about their own pattern, had it named years earlier by a professional, owned the tools, and could not make the tools work. That is where most people start, and it's why this week is what it is.</p>
<p>Before we began they wrote down what happens, and I read it back to them. "A situation I find myself in frequently is anxiety and overwhelm with work, then problem solving by focusing on saving money so I don't have to work so intensely." And: "I feel anxiety when I'm not online for all the working hours, as if my new bosses will think I'm slacking." And then the line I want you to notice: "I feel critical of myself that I'm exhausted at the end of working and don't have the energy for meditation or exercise."</p>
<p>Read that last one again. They were already punishing themselves for being too tired at the end of the day to do the practice that was supposed to help. If you recognize that, you're who this is written for.</p>
...
<p>Then the sentence that names what this course is built against: "I feel like I've been killing myself at work for so long, and I've spent a lot of time trying to pick it apart and make it easier, and make myself not feel so burnt out and miserable. And even just trying to figure that out is tiring."</p>
...
<p>They came back with this, and it's the argument of this whole week in a client's own words. "Only one thing came up in the past week that really bothered me, and coming back to that thing, I can tell a difference. Whereas before I would ruminate on that thing, or my brain would just want to go back to fix that thing. Having spent time with it and giving it the space to get bigger, get smaller, move around, come back to it the next day, it just made the whole thing process and pass a lot easier. It's not sticky."</p>
<p>Not sticky. And then they found the mechanism themselves: "I didn't get carried away by it. I just noticed the pattern of wanting to take action because I feel this way. And then that feeling like I needed to do something dissipated."</p>
...
<p>A few weeks later they worked out why the old method had to go. I described what I'd been watching, that they used threat as a motivating force, and they corrected me. "Or just judgment." Then: "It's not working anymore. It does the opposite. It just makes me more resistant to whatever it is I think I need to be doing." The engine had stopped producing, which takes away the argument for going back to it.</p>
<p>Where they landed, in the concrete version rather than the feelings. They stopped calculating their escape: "I'm doing less math around how much longer I'm going to have to work." They work fewer hours and say so flatly: "I'm not on all the time, so I just have more time for myself. I'm not working forty hours a week. It's great." They ask for help, where before they froze: "I don't feel so frozen if someone helps me, or if I feel like I need to ask for help." And this one, which is the old pattern running backwards. Their workplace is slow. They know exactly how to make it fast. They won't. "Their processes are slow, and I know how to make them very fast, but then everyone's got to work a lot, and I don't want to do that."</p>
<p>And the honest part, because the old thing is still there and they say so. "It feels like a younger version of me, less intense, but clearly it's still around." And: "I still sometimes fall back on feeling like I'm supposed to handle it all, which definitely causes unnecessary stress, and I probably don't have to handle it all." Rest still costs them something: "If I do rest, it's almost like I feel badly for resting."</p>
<p>Two more things so you have this straight. Not all of their change came from this practice, and they said so themselves. Some of it was a therapist years ago. Some of it was a better job they went out and found. What the practice did, specifically, was make a feeling stop being sticky. That's a small claim and it's the true one. It's also the thing everything else was waiting on.</p>`,
...
<p>Now the part this week is about.</p>
...
<p>And then, twenty minutes later, he put it together himself. This is his sentence, not mine: "It helps me realize why I have this anxiety about wanting to always provide and make sure that needs are taken care of, because I feel like, if I don't, that situation could happen."</p>
...
<p>And then his own summary, which is the most honest description of finishing a piece of work like this that anyone has given me. "If anything, it's like, I'm less ignorant now. I don't have any illusions that there's no work. If anything, it's an acceptance, like, there's an acceptance of the work, and I kind of have a quantification now of what it is, and it's more that I have to do."</p>
<p>He got the promotion and the award, he can feel his own life now, and the ache is still there, and he knows where it comes from. That isn't the work failing. That's what a month, or eight sessions, or a year honestly buys you. The rest of it is the deeper work, and he said so himself: "I know I'm only scratching the surface."</p>
