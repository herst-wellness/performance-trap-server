...
<p>There's the loop, the thought and the chest feeding each other. And the way out was the same both times: make the U-turn, back into the body. "Anxiety" was the label, and the label kept it in the chest. Restricting, tight, vibrating was what was actually there, and once it was named that way, it moved.</p>
...
<p>That's the trade, right there at the table. The truth, or her comfort. A second glass, or their approval. And the shame arrives before anyone has said a word, because the deal was made a long time ago. I turned it into a question we could actually work: how can I express myself openly, without contorting myself to what other people want, and without guilt or shame?</p>
...
<p>Two roads. Stay and suffer, or leave. And everything went into which road, so there was nothing left for how to actually live on either one.</p>
